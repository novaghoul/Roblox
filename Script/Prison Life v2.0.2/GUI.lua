...
-- local table_1 = {
-- 	[1] = {
-- 		["RayObject"] = '{913.681335, 101.489967, 2444.46069}, {228.274979, -10.3842926, -554.781677}',
-- 		["Distance"] = 24.513660430908,
-- 		["Cframe"] = '917.264038, 101.116554, 2434.40991, -0.908096969, 0.000787328288, 0.418759167, 5.8207654e-11, 0.999998271, -0.00188014249, -0.418759882, -0.00170735165, -0.908095419',
-- 		["Hit"] = 'HumanoidRootPart'
-- 	}
-- };
-- local userdata_1 = game:GetService("Players").WAOKyoHana.Backpack.M9;
-- local Target = game:GetService("ReplicatedStorage").ShootEvent;
-- Target:FireServer(table_1, userdata_1);
