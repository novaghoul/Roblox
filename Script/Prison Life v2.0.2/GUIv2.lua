...
coroutine.resume(coroutine.create(SCRIPT_CIMJ66_FAKESCRIPT))
teams.MouseButton1Down:connect(
  function()
    scriptsmain.Visible = false
    homemain.Visible = false
    guismain.Visible = false
...
coroutine.resume(coroutine.create(SCRIPT_CIMJ66_FAKESCRIPT))
funcs.MouseButton1Down:connect(
  function()
    homemain.Visible = false
    guismain.Visible = false
    teamsmain.Visible = false
...
inmate.TextSize = 18
inmate.MouseButton1Down:connect(
  function()
...
neutral.TextSize = 18
neutral.MouseButton1Down:connect(
  function()
...
prisonbreakerv15.MouseButton1Down:connect(
  function()
...
prisondestroyer.MouseButton1Down:connect(
  function()
...
kickgui.MouseButton1Down:connect(
  function()
...
godmode.MouseButton1Down:connect(
  function()
...
destroy.MouseButton1Down:connect(
  function()
    ...
    for i, v in pairs(game:GetService("Players"):GetChildren()) do
      for i = 1, 650 do
        local tbl_36BA2890 = {
          ["RayObject"] = Ray.new(
            Vector3.new(839.947937, 99.4999466, 2211.61719),
            Vector3.new(-379.812744, 31.2091656, 121.524826)
          ),
        ...
        local tbl_36B5BF78 = {
          ["RayObject"] = Ray.new(
            Vector3.new(839.947937, 99.4999466, 2211.61719),
            Vector3.new(-379.036713, 35.5271149, 122.755898)
          ),
        ...
        local tbl_36B585E8 = {
          ["RayObject"] = Ray.new(
            Vector3.new(839.947937, 99.4999466, 2211.61719),
            Vector3.new(-379.921326, 20.3493805, 123.473427)
          ),
        ...
        local tbl_36B5CC38 = {
          ["RayObject"] = Ray.new(
            Vector3.new(839.947937, 99.4999466, 2211.61719),
            Vector3.new(-371.464417, 33.5804787, 144.521744)
          ),
        ...
        local tbl_36B5BB28 = {
          ["RayObject"] = Ray.new(
            Vector3.new(839.947937, 99.4999466, 2211.61719),
            Vector3.new(-376.177948, 24.8940163, 133.680374)
          ),
...
antikickon.MouseButton1Down:connect(
  function()
    antikickmainon.Visible = false
...
antikickoff.MouseButton1Down:connect(
  function()
    antikickmainoff.Visible = false
    antikickmainon.Visible = true
    wait(0.6)
    _G.Crim = true
    while _G.Crim == true do
      wait()
      do
        for i, v in pairs(game.Teams["Guards"]:GetPlayers()) do
...
modguns.MouseButton1Down:connect(
  function()
    ...
    client.Backpack.ChildAdded:connect(
      function(child)
