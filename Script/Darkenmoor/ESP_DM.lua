					...
					if p.Name == ("Head") then 
						for _, f in pairs(faces) do
							...
							o:GetPropertyChangedSignal("Team"):connect(function()
                                if tostring(o.Team) == "Frozen" then
                                    mf.BackgroundColor3 = Color3.fromRGB(13, 105, 172)
                                elseif tostring(o.Team) == "Monsters" then
                                    mf.BackgroundColor3 = Color3.fromRGB(196, 40, 28)
                                elseif tostring(o.Team) == "Humans" then
                                    mf.BackgroundColor3 = Color3.fromRGB(75, 151, 75)
                                end
                            end)
                            if tostring(o.Team) == "Frozen" then
					...
					if p.Name == ("Head") then 
						for _, f in pairs(faces) do
							...
							newPlayer:GetPropertyChangedSignal("Team"):connect(function()
                                if tostring(newPlayer.Team) == "Frozen" then
                                    mf.BackgroundColor3 = Color3.fromRGB(13, 105, 172)
                                elseif tostring(newPlayer.Team) == "Monsters" then
                                    mf.BackgroundColor3 = Color3.fromRGB(196, 40, 28)
                                elseif tostring(newPlayer.Team) == "Humans" then
                                    mf.BackgroundColor3 = Color3.fromRGB(75, 151, 75)
                                end
                            end)
                            if tostring(newPlayer.Team) == "Frozen" then
