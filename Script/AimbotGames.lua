...
getgenv().nameGame = function(name, char)
    if tostring(name) == "Prison Life v2" then
        if (tostring(char.Team)  == "Criminals" and tostring(lplr.Team)  == "Criminals") or (tostring(char.Team)  == "Inmates" and tostring(lplr.Team)  == "Inmates") or (tostring(char.Team)  == "Guards" and tostring(lplr.Team)  == "Guards") then
            return true
        end
