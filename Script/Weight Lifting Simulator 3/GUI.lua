...
TPSpace.BackgroundColor3 = Color3.new(0, 0.666667, 1)
...
-- Open:
OpenTP.MouseButton1Click:connect(
    function()
...
CloseTP.MouseButton1Click:connect(
    function()
        OpenTP.Visible = true
        CloseTP.Visible = false
        TPGUI.Visible = false
...
OpenMisc.MouseButton1Click:connect(
    function()
...
CloseMisc.MouseButton1Click:connect(
    function()
...
OpenStats.MouseButton1Click:connect(
    function()
...
CloseStats.MouseButton1Click:connect(
    function()
...
-- TP's
TPSkyGym.MouseButton1Down:connect(
    function()
        lplr.Character.HumanoidRootPart.CFrame = CFrame.new(2182.5127, 769.779114, -250.614319)
    end
)

TPUnderworldGym.MouseButton1Down:connect(
    function()
        lplr.Character.HumanoidRootPart.CFrame = CFrame.new(-778, 14, 3342)
    end
)

-- EXCLUSIVE FOR VOUCHERS!!!!!!!!
TPSpace.MouseButton1Down:connect(
    function()
        lplr.Character.HumanoidRootPart.CFrame = CFrame.new(-273, 1356, -5276)
    end
)

TPBigBoyBeach.MouseButton1Down:connect(
    function()
        lplr.Character.HumanoidRootPart.CFrame = CFrame.new(-17.6436806, 17.761467, -354.889679)
    end
)

TPTinyBeach.MouseButton1Down:connect(
    function()
        lplr.Character.HumanoidRootPart.CFrame = CFrame.new(-406.441711, 3.11410189, 119.323685)
    end
)

TPBrawlTraining.MouseButton1Down:connect(
    function()
        lplr.Character.HumanoidRootPart.CFrame = CFrame.new(5812.32813, 172.829651, 1878.08606)
    end
)

TPBrawlArena.MouseButton1Down:connect(
    function()
        lplr.Character.HumanoidRootPart.CFrame = CFrame.new(5775.31445, 43.8691788, 2338.92041)
    end
)
...
-- Automation
OpenStrength.MouseButton1Down:connect(
    function()
        ...
        while toggleStrength do
            wait(0.001)
            local A_1 = "rep"
            local A_2 = lplr.Backpack.Weight.Handle.Mesh
            local Event = lplr.strengthEvent
            Event:FireServer(A_1, A_2)
        end
    end
)

CloseStrength.MouseButton1Down:connect(
    function()
...
OpenCrate.MouseButton1Down:connect(
    function()
...
OpenBrawl.MouseButton1Down:connect(
    function()
        toggleBrawl = true
        OpenBrawl.Visible = false
        CloseBrawl.Visible = true
        while toggleBrawl do
            wait(9)
...
CloseBrawl.MouseButton1Down:connect(
    function()
        toggleBrawl = false
...
OpenCLICK.MouseButton1Down:connect(
    function()
...
CloseCLICK.MouseButton1Down:connect(
    function()
        toggleAutoclick = false
...
OpenAFK.MouseButton1Down:connect(
    function()
        toggleAntiAFK = false
...
CloseAFK.MouseButton1Down:connect(
    function()
...
CloseRebirthPet.MouseButton1Down:connect(
    function()
        toggleRebirthPet = false
...
CLOSEBUTTON_2.MouseButton1Down:connect(
    function()
        AUTOMATIONGUI.Visible = false
        OpenStats.Visible = true
        CloseStats.Visible = false
...
-- Misc
OpenDiscoSize.MouseButton1Down:connect(
    function()
...
CloseDiscoSize.MouseButton1Down:connect(
    function()
        toggleDiscoSize = false
...
OpenDiscoSkin.MouseButton1Down:connect(
    function()
        local i = 1
...
CloseDiscoSkin.MouseButton1Down:connect(
    function()
        toggleDiscoSkin = false
        CloseDiscoSkin.Visible = false
...
CloseTPKILL.MouseButton1Down:connect(
    function()
        toggleTPKILL = false
...
OpenTP_2.MouseButton1Down:connect(
    function()
        warn("xd")
...
OpenBtools.MouseButton1Click:connect(
    function()
        local a = Instance.new("Tool")
        a.RequiresHandle = false
        a.Name = "Delete"
        local b = game.Players.LocalPlayer
        a.Parent = b:WaitForChild("Backpack")
        local c = b:GetMouse()
        local d = false
        local e = Instance.new("SelectionBox")
        e.Color3 = Color3.new(0, 0.6, 0.6, 6)
        e.Parent = b.PlayerGui
        local c = b:GetMouse()
        local e = Instance.new("SelectionBox")
        e.Color3 = Color3.new(0, 0.6, 0.6, 6)
        e.Parent = b.PlayerGui
        ...
        a.Activated:Connect(
            function()
                if e.Adornee then
                    local g = Instance.new("Explosion")
                    g.Parent = game.Workspace
                    g.Position = e.Adornee.Position
                    g.BlastPressure = 0
                    local h = Instance.new("Sound")
                    h.SoundId = "http://www.roblox.com/asset/?id=315775189"
...
OpenSize.MouseButton1Down:connect(
    function()
...
OpenDiscoPet.MouseButton1Down:connect(
    function()
        local i = 1
        toggleDiscoPet = true
...
CloseDiscoPet.MouseButton1Down:connect(
    function()
        toggleDiscoPet = false
...
CLOSEBUTTON_3.MouseButton1Down:connect(
    function()
        MISCGUI.Visible = false
        OpenMisc.Visible = true
        CloseMisc.Visible = false
...
function createHitBox(parent)
    ...
    parent.Character[_G.hitBoxBody].Size =
