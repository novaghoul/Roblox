...
window3:Button("Infinite Nitro", function()
    game:GetService("RunService").RenderStepped:Connect(function()
        if workspace.ObjectSelection:FindFirstChild(game.Players.LocalPlayer.Name .. "'s Vehicle") then
            pcall(function()
                workspace.ObjectSelection[game.Players.LocalPlayer.Name .. "'s Vehicle"].CarChassis.Boost.Value = 20;
            end)
        end
    end)
end)
...
window6:Button("Infinite Ammo", function()
    game:GetService("RunService").RenderStepped:Connect(function()
        local function main(v)
            if v.Name == "RifleScript" or v.Name == "ShotgunScript" or v.Name == "PistolScript" or v.Name ==
                "TazerScript" or v.Name == "PowerScript" then
                local a = getsenv(v)
...
window5:Button("Prison", function()
    ...
    function tp(...)
        ...
        game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart,
...
window5:Button("Plane", function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(
        game.Workspace.CargoPlane.Plane.Tele1.Position)
end)
...
window2:Button("Be Black", function()
    for i = 1, 3 do
        ...
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
            CFrame.new(1203.02539, 51058.3906, 552.828857, 0, -1, 0, 1, 0, -0, 0, 0, 1)
        wait(1)
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
            CFrame.new(1203.02539, 51058.3906, 533.490723, 0, -1, 0, 1, 0, -0, 0, 0, 1)
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
            CFrame.new(1203.02539, 51058.3906, 552.828857, 0, -1, 0, 1, 0, -0, 0, 0, 1)
    end
end)
...
window2:Button("Get All Gamepasses", function()
    game.ReplicatedStorage.Event:FireServer("Dialogue", {{
        Text = "Car Radio, Emotes,Mobile Shop, Has Been Given",
        Delay = 2
    }})
    wait()
...
window1:Button("Crash Server", function()
    if game.Players.LocalPlayer.Backpack:FindFirstChild("Shotgun") == nil then
        ...
        for i = 1, 8000 do
            game:GetService("ReplicatedStorage").Event:FireServer("ShootShotgun", workspace[plr.Name],
                Vector3.new(0, 0, 0), "Shotgun", "inf", "inf", "inf")
        end
        game:GetService("StarterGui"):SetCore("SendNotification", {
    ...
    if game.Players.LocalPlayer.Backpack:FindFirstChild("Grenade") == nil then
        ...
        UserInputService.InputBegan:Connect(function(input, isProcessed)
            ...
            if input.KeyCode == Enum.KeyCode.F then
                for c = 1, bbgwqqwe do
                    game:GetService("ReplicatedStorage").Event:FireServer("ThrowGrenade", Vector3.new(-1626.83398,
                        43.1575661, 689.200378))
                end
            end
        end)
...
window1:Button("Plane", function()
    if game.Workspace.CargoPlane.Plane == nil then
        ...
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
            CFrame.new(232.338531, 51095.75, 513.972473, 1, 0, 0, 0, 1, 0, 0, 0, 1)
        wait(1)
        workspace.ObjectSelection.PlaneButton.PlaneButton.PlaneButton.Event:FireServer()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
            CFrame.new(231.832428, 51067.2266, 489.710938, 1, 0, 0, 0, 1, 0, 0, 0, 1)
        wait(2)
        tp(2062, 26, 429)
        wait(2)
        tp(2101, 27, 426)
